  ...
  return (
    ...
    >
      <Link
        ...
        className="w-[90%] shadow-xl shadow-primary h-full bg-black border border-primary rounded-xl px-6 py-2 sm:px-10 lg:p-3 flex flex-col lg:flex-row items-center justify-between hover:scale-110 transition-transform ease-in-out lg:space-x-3"
      >
