...
function Page() {
  return (
    <div className="py-10 flex flex-col space-y-10 text-light max-w-7xl mx-auto px-1 lg:px-0">
      <h1 className="text-center text-3xl font-black">Privacy</h1>
      <div className="space-y-10 text-center">
        <div className="space-y-5">
          <h2 className="text-xl font-black">1. Introduction</h2>
          <p>
            Welcome to Retro Boosting! At Retro Boosting, we respect your
            privacy and are committed to protecting your personal information.
            This Privacy Policy explains how we collect, use, disclose, and
            safeguard your information when you use our website and services. By
            using Retro Boosting, you consent to the practices described in this
            Privacy Policy.
          </p>
        </div>
        <div className="space-y-5">
        ...
        <div className="space-y-5">
          <h2 className="text-xl font-black">3. How We Use Your Information</h2>
          <p>
            a. To Provide Services: We use your personal information to provide
            the services you request, including Elo boosting, arena boosting,
            and coaching.
          </p>
          <p>
          ...
          <p>
            c. To Communicate: We may use your email address to send you
            updates, newsletters, and promotional materials. You can opt out of
        ...
        <div className="space-y-5">
          ...
          <p>
            b. Legal Requirements: We may disclose your information to comply
            with legal obligations, enforce our policies, respond to legal
            actions, or protect our rights, privacy, safety, or property.
          </p>
        </div>
        <div className="space-y-5">
          <h2 className="text-xl font-black">5. Your Choices</h2>
          <p>
            a. Opt-Out: You can opt out of receiving promotional emails from us
            by following the instructions in those emails. However, we may still
        ...
        <div className="space-y-5">
          <h2 className="text-xl font-black">6. Security</h2>
          <p>
            We take reasonable steps to protect your personal information from
            unauthorized access, disclosure, alteration, and destruction.
            However, please note that no data transmission over the internet is
            100% secure, and we cannot guarantee the security of your
            information.
          </p>
        </div>
        <div className="space-y-5">
        ...
        <div className="space-y-5">
          <h2 className="text-xl font-black">8. Contact Us</h2>
          <p>
