...
function page() {
  return (
    <div className="py-10 flex flex-col space-y-10 text-light max-w-7xl mx-auto px-1">
      <h1 className="text-center text-3xl font-black">Terms</h1>
      <div className="space-y-10 text-center">
        ...
        <div className="space-y-5">
          ...
          <p>
            By accessing or using Retro Boosting, you acknowledge that you have
            read, understood, and agree to be bound by these Terms. We may
            update or modify these Terms at any time, and it is your
            responsibility to review them periodically.
          </p>
        </div>
        <div className="space-y-5">
          <h2 className="text-xl font-black">2. Privacy Policy</h2>
          <p>
            Your use of Retro Boosting is also governed by our Privacy Policy,
        ...
        <div className="space-y-5">
          <h2 className="text-xl font-black">3. User Conduct</h2>
          <p>
            You agree to use Retro Boosting for lawful purposes only. You are
            prohibited from engaging in any activity that may violate local,
            state, national, or international laws or regulations.
          </p>
        </div>
        <div className="space-y-5">
          <h2 className="text-xl font-black">4. Account Registration</h2>
          <p>
        ...
        <div className="space-y-5">
          <h2 className="text-xl font-black">5. Prohibited Activities</h2>
          <p>
        ...
        <div className="space-y-5">
          <h2 className="text-xl font-black">6. Intellectual Property</h2>
          <p>
            All content on Retro Boosting, including but not limited to text,
            graphics, logos, images, and software, is protected by intellectual
            property rights. You may not reproduce, distribute, or modify any
            content without our prior written consent.
          </p>
        </div>
        <div className="space-y-5">
          <h2 className="text-xl font-black">7. Termination</h2>
          <p>
            We reserve the right to terminate or suspend your access to Retro
            Boosting at our discretion, with or without cause and without
            notice. You may also terminate your account at any time by
            contacting us.
          </p>
        </div>
        <div className="space-y-5">
          <h2 className="text-xl font-black">8. Disclaimer of Warranty</h2>
          <p>
        ...
        <div className="space-y-5">
          ...
          <p>
            To the fullest extent permitted by law, Retro Boosting shall not be
